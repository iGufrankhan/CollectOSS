...
def get_user_repo_insert_statement(repo_id, group_id):
    ...
    return """INSERT INTO "operations"."user_repos" ("repo_id", "group_id") VALUES ({}, {});""".format(repo_id, group_id)
...
def get_user_insert_statement(user_id, username="bil", email="default@gmail.com", password="pass"):
    ...
    return """INSERT INTO "operations"."users" ("user_id", "login_name", "login_hashword", "email", "first_name", "last_name", "admin") VALUES ({}, '{}', '{}', '{}', 'bill', 'bob', false);""".format(user_id, username, User.compute_hashsed_password(password), email)
...
def get_user_group_insert_statement(user_id, group_name, group_id=None):
    ...
    return """INSERT INTO "operations"."user_groups" ("user_id", "name") VALUES ({}, '{}');""".format(user_id, group_name)
